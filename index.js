...
(async () => {
  try {
    ...
    await page.goto(
      "https://www.nike.com/launch/t/air-jordan-legacy-312-wheat-varsity-red/"
    );
    ...
    await page.keyboard.type("123 Fake St");
    await page.waitForSelector(FIRST_NAME_INPUT);
    ...
    await page.keyboard.type("10013");
    await page.waitForSelector(FIRST_NAME_INPUT);
    await page.click(EMAIL);
    await page.keyboard.type("lmfao@lol.com");
    await page.waitForSelector(FIRST_NAME_INPUT);
